...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/home/LiangJing/TinyLLaVA_Factory/TinyLLaVA-Phi-2-SigLIP-3.1B")
    parser.add_argument("--model", type=PreTrainedModel, default=None)
    parser.add_argument("--image-file", type=str, default="/home/LiangJing/TinyLLaVA_Factory/dataset/gqa/images/2331819.jpg")
    parser.add_argument("--query", type=str, default="Who is wearing a shirt?")
