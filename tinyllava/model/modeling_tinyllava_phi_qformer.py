...
class TinyLlavaForConditionalGeneration(TinyLlavaPreTrainedModel):
    def __init__(self, config: TinyLlavaConfig):
        ...
        self.qformer_round1 = QFormer(config)
        self.qformer_round2 = QFormer(config)
        self.post_init()
    ...
    def encode_images_with_text(self, images, input_ids, round_number):
        ...
        if round_number == 1:
            multimodal_features = self.qformer_round1(image_features, text_features)
        elif round_number == 2:
            multimodal_features = self.qformer_round2(image_features, text_features)
        else:
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if images.ndim == 5:
            ...
            for pos in image_positions:
                ...
                prev_pos = pos + 1
            split_input_ids.append(input_ids[:, prev_pos:])
