...
from tinyllava.data.dataset_ic2t import make_supervised_data_module
from tinyllava.model.modeling_tinyllava_phi_qformer import TinyLlavaConfig, TinyLlavaForConditionalGeneration  # 导入自定义的模型类和配置类
